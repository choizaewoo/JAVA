...
public class GyeonggiBakery {
	...
	public static void main(String[] args) throws IOException {
		...
		File f1 = new File("C:\\Users\\kopo\\day_data\\Busanbakery.csv");
...
//		}
		...
		// 검색 입력
		driver.findElement(By.xpath("/html/body/div[3]/div[1]/div/div[1]/div[1]/div/form/fieldset/div[1]/input")).sendKeys("경기도 빵 집");
		...
		String tt;
			...
			for (int j = 1; j <= 120; j++) {
				String s = driver.findElement(By.xpath(
						"/html/body/div[3]/div[2]/div/div[1]/section/div/div[2]/panel-list/div[1]/more-contents/div/ul/li[" + j + "]/div[1]/div/a\r\n")).getText();
